package com.mgtriffid.games.cotta.core.codegen

object Constants {
    const val COMPONENTS_CLASS_SUFFIX = "Components"
    ...
    const val FACTORY_METHOD_PREFIX = "create"
    const val COPY_METHOD = "copy"
}
